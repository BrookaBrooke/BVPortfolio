...
const SocialNavMobile = () => {
  ...
  return (
    <div name="socials" className="bg-gradient-to-b from-black to gray-800 text-white md:h-screen">
    <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        <div className="pb-8">
            <p className="text-4xl font-bold inline border-b-4 border-gray-500">Social Media Links</p>
         </div>
